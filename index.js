...
mongoose.connect("mongodb://" + process.env.DB_USERNAME + ":" + process.env.DB_PASSWORD + "@" + process.env.DB_HOST + "/endemik?authSource=admin", { useNewUrlParser: true, useUnifiedTopology: true });
